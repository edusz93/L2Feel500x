...
##                   Configurações                       ##
###########################################################
$panel_url = 'http://l2feel.com/ucp'; // Digite exatamente o URL onde se encontra este painel (exemplo: www.l2server.com/ucp)
...
$funct['forgot'] = 0; // Recuperar conta através do painel
...
##                  Aquisição de Saldo                   ##
###########################################################
$coinName = 'Credito'; // Nome da moeda online que representa o saldo (usada apenas no painel de usuário)
...
$coinGame = 'Tickt of Donate'; // Nome da moeda donate in-game (geralmente Coin, Ticket ou Gold)
$coinID = 13000; // ID da moeda
...
$PayPal['business_email'] = 'edusz1993@gmail.com'; // Email da conta que receberá as doações
...
$MercadoPago['client_id'] = '7162599346585846'; // "CLIENT_ID" presente na página https://www.mercadopago.com/mlb/account/credentials?type=basic
$MercadoPago['client_secret'] = 'zLZV1Y6TZXdinjP4FRQQqWm1SQ9xJ5vV'; // "CLIENT_SECRET" presente na página https://www.mercadopago.com/mlb/account/credentials?type=basic
...
<b>AGÊNCIA:</b> 0428-6<br />
<b>CONTA:</b> 86868-X<br />
<b>TITULAR:</b> EDUARDO DA SILVA SOUZA<br />
';
