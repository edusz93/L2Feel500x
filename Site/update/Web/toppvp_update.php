<?php
$buscar_pvp_pk = mysqli_query($acis, "SELECT obj_Id, char_name, level, pvpkills, pkkills, online, clanid FROM characters WHERE accesslevel = 0 ORDER BY pvpkills  DESC LIMIT 4") or die(mysqli_error());
?>

<table width="100%"  border="0" cellpadding="0" cellspacing="0" style=" margin-top:-16px; margin-right:15px;" align="center">
<tr style="background-color:#A4CAD2; color:#FFF; font-size:18px; font-weight:600;">
...
<td align="center" style="border-right: 1px solid #EBF3F5; font-size:11px;" width="21%"><?php echo $mostrar->char_name; ?></td>
<td style="border-right: 1px solid #EBF3F5; font-size:11px;" align="center" width="21%"><?php echo $name_clan; ?></td>
<td align="center" style="border-right: 1px solid #EBF3F5; font-size:11px;" width="9%"><?php echo $mostrar->pvpkills; ?></td>
<td align="center" style="font-size:10px;" width="9%"><?php echo $mostrar->pkkills; ?></td>
</tr>
<?php } ?>
</table>
