...
$server_url = 'www.l2feel.net'; // Digite exatamente o URL onde se encontra este site (exemplo: www.l2server.com)
...
$host = 'auth.l2feel.net'; // Endereço do host
$dbnm = 'L2JBrazuca'; // Nome do banco
$user = 'root'; // Usuário
$pass = '6gVRMh5j#gP3rYc'; // Senha
...
##                    Server Status                      ##
###########################################################
$serverIp = 'auth.l2feel.net'; // IP do DB (para buscar o status do servidor)
...
$forceServerStatus = 'off'; // Auth Status (Padrão: auto)

###########################################################
##              Atualstudio Web Admin 3.0                ##
###########################################################
$admpass = 'xunda157'; // Senha do painel admin


###########################################################
##               Configurações de e-mail                 ##
###########################################################
$admin_email = 'edusz1993@gmail.com'; // Endereço de e-mail que os jogadores podem utilizar para entrar em contato
$server_email = 'edusz1993@gmail.com'; // Seu endereço de e-mail utilizado para enviar e-mails automáticos (exemplo: nao-responda@seuservidor.com)
...
$SMTP_host = 'mail.l2feel.net'; // Endereço do Host do SMTP
...
$SMTP_user = 'admin@l2feel.net'; // Usuário de autenticação do SMTP (geralmente o e-mail remetente)
...
###########################################################
$cacheDelayMin = 5; // Intervalo em minutos que os caches de rankings são atualizados. Ex: se inserir '1' os rankings do site serão atualizados a cada 1 minuto
...
$asideRankCount = 5; // Quantidade de resultados exibidos nos rankings na lateral do site
...
$bossJwlIds = "6656,6657,6658,6659,6660,6661,6662,8191"; // IDs das Boss Jewels (Baium Ring, Antharas Earring, etc)
...
$showPlayersOn = 1; // Exibir quantidade de jogadores online? (1 = Sim | 0 = Não)
$showChatOn = 1; // Exibir suporte chat on? (1 = Sim | 0 = Não)
...
###########################################################
$coinName = 'Tickt of Donate'; // Nome do item donate
...
$bannerDelay = 5; // De quantos em quantos segundos os banners na página inicial se revesam?
