...
<style>
	.banner, .banner > .imgs a, .banner > .imgs a img, .banner .bdetail { width: 448px !important; height: 170px !important; }
</style>
<?php
...
"src="https://discord.com/widget?id=1012356880191983616" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe></center>
...
<?php if($faceBoxOn == 1) { ?>
	...
	<style>
		.faceIndex { width: 400px !important; height: 0px !important;}
	</style>
	<div class='faceIndex'>
		<div class="fb-page" data-href="<?php echo $facePage; ?>" data-width="400" data-height="0" data-hide-cover="false" data-show-facepile="true" data-show-posts="true"><div class="fb-xfbml-parse-ignore"></div></div>
	</div>
<?php } ?>
