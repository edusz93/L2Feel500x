...
<h1 style="text-align: left;"><?php echo $LANG[13001]; ?></h1>
...
if ($newID != 'all') {
    ...
    <div style="width: 100%; text-align: center;">
        <div style="display: inline-block;">
            <img width="100" height="100" src="<?php echo $newsImage; ?>" style="border-radius: 5px; vertical-align: middle;" />
        </div>
    ...
    <div class="pddInner" style="text-align: justify;">
        <?php echo encodeNew($newTxt); ?>
        <input style="margin: 40px auto 0; display: block;" type="button" onclick="history.back();" class="default" value="<?php echo $LANG[13004]; ?>" />
    </div>
    ...
    if ($totalNews > 0) {
        for ($i = 0; $i < $totalNews; $i++) {
            ...
            echo "
            <table style='width:70%; margin-left:15%;' border='0' class='tablenews'>
              <tr>
